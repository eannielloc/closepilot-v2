...
async function initDb() {
  ...
  const tables = [
    ...
    `CREATE TABLE IF NOT EXISTS document_fields (id INTEGER PRIMARY KEY AUTOINCREMENT, document_id INTEGER NOT NULL, field_type TEXT NOT NULL, label TEXT, page INTEGER NOT NULL DEFAULT 1, x REAL NOT NULL, y REAL NOT NULL, width REAL NOT NULL DEFAULT 20, height REAL NOT NULL DEFAULT 5, required INTEGER DEFAULT 1, assigned_to TEXT, font_size REAL DEFAULT 14, FOREIGN KEY (document_id) REFERENCES documents(id))`
  ];
